...
var testRecord1 core.LogRecord = core.LogRecord{
	...
	LogAttributes: map[string]any{
		"http.method": "POST",
		"http.status_code": int32(504),
		"retry_count": int32(3),	
	},
	ResourceAttributes: map[string]any{},
}

var testRecord2 core.LogRecord = core.LogRecord{
...
var testRecord3 core.LogRecord = core.LogRecord{
...
func setupTestDB(t *testing.T, ctx context.Context, store storage.LogStore) {
	...
	seedData := []core.LogRecord{testRecord1, testRecord2, testRecord3}
...
func TestBatchInsert(t *testing.T) {
	...
	testRecords := []core.LogRecord {testRecord1}
...
func TestBatchInsertMultipleLogs(t *testing.T) {
	...
	testRecords := []core.LogRecord{testRecord1, testRecord2}
	err = logStore.BatchInsert(ctx, testRecords)
	if err != nil {
		t.Fatalf("batch insert failed: %v", err)
	}
